...
let teamRegistry = JSON.parse(localStorage.getItem('cricStatTeamRegistry')) || {}; // Used for Manual Entry
...
async function authenticateCloudMatch() {
    ...
    // THIS IS WHERE THE WIPE HAPPENS (ONLY WHEN STARTING A NEW MATCH)
